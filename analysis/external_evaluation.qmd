...
smvar_evals <- read_tsv(
  here("data/external-evaluations/Q100-ext-evals-2025-04-11_smvars.tsv"),
  show_col_types = FALSE,
  name_repair = "universal"
)

stvar_evals <- read_tsv(
  here("data/external-evaluations/Q100-ext-evals-2025-04-11_stvars.tsv"),
  show_col_types = FALSE,
  name_repair = "universal"
)
