...
```{r}
stvar_curations %>% filter(correct.in.benchmark != "yes") %>% count(callset, JZcorrect.in.benchmark)
```
```{r}
stvar_evals %>% filter(correct.in.benchmark != "yes", correct.in.callset == "yes")
```
