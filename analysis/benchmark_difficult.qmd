...
TODO - diff plots need to be revised and fix inputs
...
TODO - check warning message expected pieces with additional discarded pieces for 24 rows, assume this is all the rows
```{r}
diff_cov_total_df %>%
  filter(
    ref != "CHM13v2.0",
