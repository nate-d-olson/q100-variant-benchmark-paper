...
assert_that(
 ...
 has_name(bench_var_metrics_df, c("bench_version", "ref", "bench_type", "metric", "value")),
 nrow(bench_var_metrics_df) > 0,
 all(bench_var_metrics_df$bench_version == "v5.0q"),
 all(bench_var_metrics_df$ref %in% c("GRCh37", "GRCh38", "CHM13v2.0")),
 all(bench_var_metrics_df$bench_type %in% c("smvar", "stvar"))
)
```
...
assert_that(
 is_tibble(sv_len_df),
 has_name(sv_len_df, c("CHROM", "POS", "SVTYPE", "SVLEN", "TRF", "TRFstart", "TRFend", "TRFlen")),
 nrow(sv_len_df) > 0,
