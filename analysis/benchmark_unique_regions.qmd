...
read_variant_table_parquet <- function(path, bench_type, benchmark_only = TRUE) {
  ...
  # Read Parquet file - columns are already properly named
  ...
  # Ensure context_ids and region_ids are character
  ...
  # Map var_type to variant_type with appropriate prefixes
  if (bench_type == "smvar") {
